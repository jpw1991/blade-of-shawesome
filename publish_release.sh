...
RELEASEDIR=BladeOfShawesome/bin/Release
DLL=$RELEASEDIR/BladeOfShawesome.dll
...
PLUGINS=BladeOfShawesome/Package/plugins
README=README.md
...
ZIPDESTINATION="../bin/Release/BladeOfShawesome.$VERSION.zip"
